...
export const ManageNotification = () => {
    ...
    const [getNotifications] = useMutation(getNotificationsRequest, { useAuth: true });

    const [deleteNotifications] = useMutation(deleteNotificationsRequest, { useAuth: true });
            ...
            <StyledManageNotification.Header>
                <div>
                    <StyledManageNotification.Button>
                        <Button type="button" colorType="danger" onClick={handleDelete}>
                            전체 삭제
                        </Button>
                    </StyledManageNotification.Button>
                </div>
